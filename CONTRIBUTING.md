...
configure beman.monadics to fetch them automatically via CMake FetchContent.
...
```bash
cmake -LH -S . -B build | grep "BEMAN_MONADICS" -C 2
```
...
### `BEMAN_MONADICS_INSTALL_CONFIG_FILE_PACKAGE`
