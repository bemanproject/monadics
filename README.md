...
[![Continuous Integration Tests](https://github.com/bemanproject/monadics/actions/workflows/ci_tests.yml/badge.svg)](https://github.com/bemanproject/monadics/actions/workflows/ci_tests.yml)
...
You can disable building examples by setting CMake option `BEMAN_MONADICS_BUILD_EXAMPLES` to
`OFF` when configuring the project.
